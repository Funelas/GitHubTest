...
function capitalizeFirstLettter(string){
...
function displayPokemonDetails(pokemon){
    ...
    document.querySelector(".name-wrap .name").textContent = capitalizePokemonLetter;
...
stats.forEach(({stat, base_stat}) => {
    ...
    createAndAppendElement(statDiv, "progress", {className: "progress-bar",value: base_stat, textContent: statNameMapping[stat.name],max: 100,});
